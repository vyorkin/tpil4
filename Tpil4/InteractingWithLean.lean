...
namespace My4
  ...
  -- attribute [local instance] instLe объявляет instLe экземпляром класса типов LE,
...
namespace My5
  ...
  -- Он нужен для классов типов. Об этом позже будет.
end My5
...
--
-- Оператор ↑ — это синтаксический сахар, за которым стоит класс типов Coe.
